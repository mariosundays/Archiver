...
├── app/                  PySide6 UI
└── tests/                207 tests: python tests/run_all.py
```
...
207 tests, no Houdini, no Cinema 4D, no dependencies. The Qt-dependent ones
...
**v0.3.1** — all six steps of the wizard. See [CHANGELOG.md](CHANGELOG.md).
